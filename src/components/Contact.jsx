...
emailJs.send('service_5fbvzgr',
  'template_6umm508',
  {
   from_name:form.name,
   to_name:'Udit',
   from_email:form.email,
   to_email:'contactreoo@gmail.com',
 ...
 .then(()=>{
  setLoading(false)
  alert("Thank you for reaching out! Your message has been successfully sent. I'll get back to you as soon as possible.")
